                        ...
                        <tbody>
                            ...
                            <form action="UpdateCheckout">
                                ...
                                <input type="hidden" name="productid" value="${P.id}">
                                    ...
                                    <td>${P.createdDate}</td>
                                    <td>${P.categoryid}</td>
                                    <td><a class="btn btn-outline-danger" href="UpdateProduct?id=${P.id}"><i class="bi bi-trash"></i>Edit</a>
                                    <a class="btn btn-outline-danger" onclick ="Delete(${P.id})" ><i class="bi bi-trash"></i>Delete</a></td>
                                </tr>
                            </form>
