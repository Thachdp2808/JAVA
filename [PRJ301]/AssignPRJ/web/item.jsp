...
<html lang="en">
    ...
    <body>
        <!-- Navigation-->
        <nav class="navbar navbar-expand-lg navbar-light " style="position: fixed;max-width: 100%;top: 0;left: 0;right: 0;z-index: 1;background-color: #e3f2fd;">
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="d-flex my-2">
                        <a class="btn btn-outline-dark" type="submit" href="Checkout">
