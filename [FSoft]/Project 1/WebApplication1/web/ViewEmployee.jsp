            ...
            <div class="row" style="border: none;">
                ...
                <div class="col-md-10 pb-5" style="border-left: 1px solid #dcdcdc;border-top: 1px solid #dcdcdc;">
                    <div class="title mt-3" style="border-bottom: 1px solid #f4f4f4;">
                        <h2 style="margin-left: 10px;">View Employee</h2>
                    </div>
                    <div class="card" style="border: none;">

                        <div class="card-body px-4 pt-0">
                            <form action="ViewController" id="edit" onsubmit="myEditProfile(event)" method="post">
                                <input  type="hidden" class="form-control" id="firstname" name="id"
                                ...
                                <div class="form-group" style="width: 100%;">
                                    <label for="gender" style="font-weight: bold;">
                                        ...
                                        <c:if test="${em.gender == 1}">
                                        <input class="ml-5" name="gender" type="radio" id="female" value="Female" >
                                    <label>Female</label>
                                    <input class="ml-5" name="gender" type="radio" id="male" value="Male" checked="checked">
                                    <label>Male</label>
                                    </c:if>
                                     <c:if test="${em.gender == 0}">
                                        <input class="ml-5" name="gender" type="radio" id="female" value="Female" checked="checked">
                                    <label>Female</label>
                                ...
                                <div class="form-group" style="width: 100%;">
                                    ...
                                    <input class="form-control" id="address" name="address" rows="3" value="${em.address}">
                                ...
                                <div class="form-group" style="width: 100%;">
                                    ...
                                    <select class="form-control" name="department" id="cars" value="${em.department_name}">
                                ...
                                <div class="form-group" style="width: 100%;">
                                    ...
                                    <input class="form-control" id="remark" name="remark" rows="3" value="${em.remark}">
